...
#source = codecs.open("data/source.txt", 'w', 'utf-8')
#target = codecs.open("data/target.txt", 'w', 'utf-8')

#with codecs.open('data/b_source.csv', 'r', 'utf-8') as f:
#    lines = f.readlines()
 #   for line in lines:
...
with open('data/source_part.txt', 'r') as f:
    source_data = f.read()

with open('data/target_part.txt', 'r') as f:
    target_data = f.read()
...
input_word = 'Unknown assailants threw hand grenades at the Speke Hotel in Kampala, Uganda, killing two Burundi nationals and injuring 10 others. The explosion caused minor damage to the hotel. The Sheraton Hotel was also attacked after this bombing.'
